    ...
    public ResponseEntity<News> partialUpdateNews(@PathVariable(value = "id", required = false) final Long id, @RequestBody News news)
        ...
        Optional<News> result = newsRepository
            ...
            .map(existingNews -> {
                ...
                if (news.getTop() != null) {
                    existingNews.setTop(news.getTop());
                }
                if (news.getTopTime() != null) {
                    existingNews.setTopTime(news.getTopTime());
                }
                if (news.getCreateTime() != null) {
                    existingNews.setCreateTime(news.getCreateTime());
                }
                if (news.getUpdateTime() != null) {
                    existingNews.setUpdateTime(news.getUpdateTime());
                }
                if (news.getReadCount() != null) {
                    existingNews.setReadCount(news.getReadCount());
                }
